...
public class ImageCache {
	...
	private static final String FRAGMENT_IMAGE_CACHE = "FRAGMENT_IMAGE_CACHE";
	
	
	public static final float MEM_CACHE_20_PERCENT = 0.2f;
	public static final String DISK_CACHE_FILE = "imageCache"; 
    ...
    private static RetainFragment findOrCreateRetainFragment(FragmentManager fm) {
        ...
        RetainFragment mRetainFragment = (RetainFragment) fm.findFragmentByTag(FRAGMENT_IMAGE_CACHE);

        // If not retained (or first time running), we need to create and add it.
        if (mRetainFragment == null) {
            mRetainFragment = new RetainFragment();
            fm.beginTransaction().add(mRetainFragment, FRAGMENT_IMAGE_CACHE).commitAllowingStateLoss();
        }
